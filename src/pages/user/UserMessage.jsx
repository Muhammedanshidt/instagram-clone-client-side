            ...
            {user.length > 0 ? (
              <div className="flex flex-col m-6 gap-2">
                {user.map((item) => (
                  <div
                    key={item._id}
                    className="flex items-center gap-2 bg-slate-100 p-2 rounded-3xl"
                  >
                    <img
                      className="rounded-full w-16 mt-2 object-contain"
                      src={
                        item.profileimage ||
                    ...
                    <div>
                      ...
                      <p className="m-2 font-normal text-sm text-slate-600">
                        Active 1 h ago
                      </p>
                    </div>
                  </div>
