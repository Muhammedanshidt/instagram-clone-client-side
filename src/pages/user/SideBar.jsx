...
const SideBar = () => {
  ...
  return (
    <div className="w-fit" id="scrollTabHide">
      
    <div
      className={`fixed  h-fit p-2 text-white bottom-[1px] w-[20%] hidden sm:block`}
    >
    ...
    <div className="ml-0 sm:ml-60 h-full w-fit " id="scrollTabHide">
      <Outlet />
    </div>

    {/* Main Content */}

    <div className="fixed bottom-0 w-full bg-white sm:hidden">
      <div className="flex gap-10 justify-evenly bg-teal-300 px-4 py-2">
        <div>
