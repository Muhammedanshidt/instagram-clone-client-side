        ...
        >
         ...
         {previewVideo && (
          <div className="inline-block mx-72 rounded-md my-20 shadow-2xl">
            <div>
      <video width="400" controls className="rounded-t-md" onLoadedMetadata={handleLoadedMetadata}> 
        <source src={previewVideo} type="video/mp4" />
        Your browser does not support the video tag.
      </video>
      </div>
      <div className="flex justify-between mx-3">
        <button className="hover:text-red-500 text-lg font-semibold w-fit p-1"onClick={()=> setPreviewVideo(null)}>cancel</button>
        <button className="hover:text-blue-600 text-lg font-semibold w-fit p-1">post</button>
      </div>
      </div>
    )}
