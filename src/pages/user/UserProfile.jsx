      ...
      <div className="flex ">
        ...
        <div className=" w-[700px] h-[250px]  flex-col ">
          <div className="flex gap-6 mt-6">
            ...
            <button
              className="bg-gray-200 p-1 text-sm font-medium w-[90px] h-[30px] rounded-lg  "
            ...
            <IoIosSettings
              ...
              onClick={() =>
                document.getElementById("my_modal_3_settings").showModal()
              }
            />

            <dialog
              id="my_modal_3_settings"
          ...
          <div className="flex gap-8 mt-6">
            <p>
              {" "}
              <span className="font-medium">{userData.post?.length}</span> posts
            </p>
            <p>
              {" "}
          ...
          <div className="mt-5">
            <p className="font-medium font-mono text-lg mb-2">
              {userData?.fullname}
            </p>
