...
function SignUp() {
  ...
  return (
    <div className="flex justify-center items-center flex-col">
      <div className="w-[350px] h-[600px] mt-3 flex items-center border border-1 border-gray-300 flex-col ">
        <div className="">
          <img className="mt-12" src={TitleImage} alt="Logo" style={{ width: "175px", height: "50px" }} />
        </div>
        <div>
          <h3 className="text-center text-base mt-4 font-semibold text-gray-500 leading-4">
            Sign up to see photos and videos
      ...
      <div className="w-[350px] h-18 mt-2">
        ...
        <div className="flex gap-3 flex justify-center my-6">
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <img className="h-[40px]" src={Microsoft} alt="Microsoft store logo" />
          </a>
        </div>
      </div>
    </div>
